        ...
        <div class="container">
            <div class="slider-section__head">
                <h2 class="caption caption--h2">
                    <?php Site::includeArea(SITE_DIR . "include/pages/special_front.php"); ?>
                </h2>
                <a href="/special/" class="link link--arrow">
                    <?php Site::includeArea(SITE_DIR . "include/pages/special_front_more.php"); ?>
                </a>
            </div>
                                    ...
                                    <div class="slider-default__content">
                                        ...
                                        <?php if (isset($arItem['DISPLAY_PROPERTIES']['PRICE'])) { ?>
                                            <span class="slider-default__price">
                                                <?php echo Loc::getMessage('CP_SPECIAL_FRONT_PRICE', ['#PRICE#' => Site::currencyFormat($arItem['DISPLAY_PROPERTIES']['PRICE']['VALUE'])]); ?>
                                            </span>
                                        <?php } ?>
                                    </div>
                                </div>
