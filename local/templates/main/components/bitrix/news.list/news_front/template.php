        ...
        <div class="container">
            <div class="slider-section__head">
                <h2 class="caption caption--h2">
                    <?php Site::includeArea(SITE_DIR . "include/pages/news_front.php"); ?>
                </h2>
                <a href="/news/" class="link link--arrow">
                    <?php Site::includeArea(SITE_DIR . "include/pages/news_front_more.php"); ?>
                </a>
            </div>
                                ...
                                <div class="slider-default__item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                                    ...
                                    <picture class="picture">
                                        <?php if ($arParams["DISPLAY_DATE"] != "N" && $arItem["DISPLAY_ACTIVE_FROM"]) {
                                            ...
                                            ?>
                                            <div class="date">
                                                <span class="day"><?php echo $objDateTime->format("d.m"); ?> <span class="mon"><?php echo $objDateTime->format("Y"); ?></span></span>
                                            </div>
                                        <?php } ?>
